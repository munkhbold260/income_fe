export default function Card() {
  return (
    <div className="w-[1440px] px-[120px] flex gap-6">
      <div className="  w-[384.12px] h-[219.66px] rounded-[18px]">
        <img
          className="h-full"
          src="https://golomtbank.com/wp-content/uploads/2020/07/Business-card.png"
        />
      </div>
      <div className=" w-[384.12px] h-[208px] rounded-[18px]">
        <div className="w-96 h-52 bg-white rounded-xl flex-col justify-start items-start inline-flex">
          ...
          <div className="self-stretch h-[152px] px-6 pt-5 pb-6 flex-col justify-start items-start gap-4 flex">
            <div className="w-[186px] flex-col justify-start items-start gap-1 flex">
              ...
              <div className="text-slate-500 text-lg font-normal   leading-7">
                Your Income Amount
              </div>
            </div>
            <div className="justify-start items-center gap-2 inline-flex">
              ...
              <div className="text-black text-lg font-normal   leading-7">
                32% from last month
              </div>
            </div>
          </div>
      ...
      <div className="bg-white w-[384.12px] h-[208px] rounded-[18px]">
        <div className="w-96 h-52 rounded-xl flex-col justify-start items-start inline-flex">
          <div className="self-stretch px-6 py-4 border-b border-slate-200 justify-start items-center gap-2 inline-flex">
            <div className="w-2 h-2 bg-lime-500 rounded-full" />
